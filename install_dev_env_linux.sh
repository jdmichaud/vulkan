...
downloadFile https://sdk.lunarg.com/sdk/download/${SDK_VERSION}/mac/vulkansdk-linux-x86_64-${SDK_VERSION}.tar.gz?u=
untarFile .download/vulkansdk-linux-x86_64-${SDK_VERSION}.tar.gz?u=
